...
HD_PWD='D:/IIITD/ELD_LABs/Lab_2_Multiplier/Multiplier/Multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Vio_Wrapper2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Vio_Wrapper2.tcl -notrace
