...
HD_PWD='D:/IIITD/ELD_LABs/Lab_2_Multiplier/Multiplier/Multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vio_Wrapper2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vio_Wrapper2.tcl
