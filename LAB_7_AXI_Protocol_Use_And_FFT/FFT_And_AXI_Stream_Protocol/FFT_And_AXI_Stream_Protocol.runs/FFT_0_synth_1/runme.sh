...
HD_PWD='D:/IIITD/ELD_LABs/ELD_LAB_7_AXI_Protocol_Use_And_FFT/FFT_And_AXI_Stream_Protocol/FFT_And_AXI_Stream_Protocol.runs/FFT_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_0.tcl
