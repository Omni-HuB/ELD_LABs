...
set rc [catch {
  ...
  add_files -quiet D:/IIITD/ELD_LABs/Lab_2_Multiplier/FullAdder_TopAdder_Multiplier/FullAdder_TopAdder_Multiplier.runs/synth_1/vio_wrapper.dcp
  ...
  link_design -top vio_wrapper -part xc7a35tcpg236-1
