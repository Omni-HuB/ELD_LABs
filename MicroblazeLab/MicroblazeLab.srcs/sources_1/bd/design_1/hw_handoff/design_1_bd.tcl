...
proc create_root_design { parentCell } {
  ...
  # Create instance: sq_root, and set properties
  set sq_root [ create_bd_cell -type ip -vlnv xilinx.com:ip:floating_point:7.1 sq_root ]
  set_property -dict [ list \
   CONFIG.C_Latency {29} \
   CONFIG.C_Mult_Usage {No_Usage} \
   CONFIG.C_Rate {1} \
  ...
  connect_bd_intf_net -intf_net fix_to_float_M_AXIS_RESULT [get_bd_intf_pins fix_to_float/M_AXIS_RESULT] [get_bd_intf_pins sq_root/S_AXIS_A]
  ...
  connect_bd_intf_net -intf_net sq_root_M_AXIS_RESULT [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins sq_root/M_AXIS_RESULT]

  # Create port connections
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports Reset] [get_bd_pins rst_Clk_100M/ext_reset_in]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_Clk_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_ports Clock] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins fix_to_float/aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/Clk] [get_bd_pins rst_Clk_100M/slowest_sync_clk] [get_bd_pins sq_root/aclk]
  ...
  connect_bd_net -net rst_Clk_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins rst_Clk_100M/peripheral_aresetn]
