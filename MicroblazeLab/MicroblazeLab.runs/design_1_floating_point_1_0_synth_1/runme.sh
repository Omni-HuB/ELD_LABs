...
HD_PWD='C:/ELD2021/MicroblazeLab/MicroblazeLab.runs/design_1_floating_point_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_floating_point_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_floating_point_1_0.tcl
