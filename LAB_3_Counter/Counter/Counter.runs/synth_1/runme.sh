...
HD_PWD='D:/IIITD/ELD_LABs/LAB_3_Counter/Counter/Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_wrapper3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_wrapper3.tcl
