...
HD_PWD='D:/IIITD/ELD_LABs/LAB_3_Counter/Counter/Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_wrapper3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vio_wrapper3.tcl -notrace
