...
HD_PWD='D:/IIITD/ELD_LABs/LAB_END_SEM_4/END_SEM/END_SEM.runs/endSem_dlmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log endSem_dlmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source endSem_dlmb_v10_0.tcl
