...
vlog -work xil_defaultlib -64 -sv "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
...
vlog -work blk_mem_gen_v8_4_3 -64 "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
"../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/c001/simulation/blk_mem_gen_v8_4.v" \

vlog -work xil_defaultlib -64 "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
...
vlog -work generic_baseblocks_v2_1_0 -64 "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
"../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work axi_infrastructure_v1_1_0 -64 "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
"../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_19 -64 "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
"../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/4d88/hdl/axi_register_slice_v2_1_vl_rfs.v" \

vlog -work fifo_generator_v13_2_4 -64 "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
...
vlog -work axi_data_fifo_v2_1_18 -64 "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
"../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/5b9c/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_crossbar_v2_1_20 -64 "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
...
vlog -work axi_protocol_converter_v2_1_19 -64 "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
...
vlog -work axi_clock_converter_v2_1_18 -64 "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
"../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ac9d/hdl/axi_clock_converter_v2_1_vl_rfs.v" \

vlog -work axi_dwidth_converter_v2_1_19 -64 "+incdir+../../../../END_SEM.srcs/sources_1/bd/endSem/ipshared/ec67/hdl" \
