...
HD_PWD='D:/IIITD/ELD_LABs/LAB_4_Moorey_and_Melley_FSM/FSM/FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_wrapper4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_wrapper4.tcl
