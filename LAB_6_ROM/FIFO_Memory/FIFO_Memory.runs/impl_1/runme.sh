...
HD_PWD='D:/IIITD/ELD_LABs/LAB_6_ROM/FIFO_Memory/FIFO_Memory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_wrapper_6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vio_wrapper_6.tcl -notrace
