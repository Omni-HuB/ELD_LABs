...
HD_PWD='D:/IIITD/ELD_LABs/LAB_6_ROM/FIFO_Memory/FIFO_Memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_wrapper_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_wrapper_6.tcl
