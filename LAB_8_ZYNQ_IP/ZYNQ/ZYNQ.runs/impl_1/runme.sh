...
HD_PWD='D:/IIITD/ELD_LABs/LAB_8_ZYNQ_IP/ZYNQ/ZYNQ.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZYNQ_block_wrapper.tcl -notrace
