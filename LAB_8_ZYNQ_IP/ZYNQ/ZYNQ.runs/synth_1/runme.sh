...
HD_PWD='D:/IIITD/ELD_LABs/LAB_8_ZYNQ_IP/ZYNQ/ZYNQ.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_block_wrapper.tcl
