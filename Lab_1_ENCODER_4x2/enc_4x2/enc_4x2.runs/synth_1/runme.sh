...
HD_PWD='D:/IIITD/SEM3/ELD_LABs/Lab_1_ENCODER_4x2/enc_4x2/enc_4x2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enc_4x2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enc_4x2.tcl
