...
HD_PWD='D:/IIITD/ELD_LABs/LAB_9_IO_BRAM_ILA/IO_BRAM_ILA/IO_BRAM_ILA.runs/IO_axi_bram_ctrl_0_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IO_axi_bram_ctrl_0_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IO_axi_bram_ctrl_0_bram_0.tcl
