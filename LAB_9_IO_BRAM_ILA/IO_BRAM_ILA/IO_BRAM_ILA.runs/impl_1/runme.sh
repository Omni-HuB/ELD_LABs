...
HD_PWD='D:/IIITD/ELD_LABs/LAB_9_IO_BRAM_ILA/IO_BRAM_ILA/IO_BRAM_ILA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IO_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IO_wrapper.tcl -notrace
