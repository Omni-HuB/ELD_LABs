...
HD_PWD='D:/IIITD/ELD_LABs/LAB_9_IO_BRAM_ILA/IO_BRAM_ILA/IO_BRAM_ILA.runs/IO_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IO_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IO_rst_ps7_0_50M_0.tcl
