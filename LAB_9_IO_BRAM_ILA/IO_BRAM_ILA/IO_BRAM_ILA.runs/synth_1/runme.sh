...
HD_PWD='D:/IIITD/ELD_LABs/LAB_9_IO_BRAM_ILA/IO_BRAM_ILA/IO_BRAM_ILA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IO_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IO_wrapper.tcl
