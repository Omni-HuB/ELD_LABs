...
#
# Generated by export_simulation on Tue Nov 30 23:41:12 +0530 2021
#
################################################################################
...
'-reset_run' switch to the './IO.sh' script.
...
For more information on the script, please type './IO.sh -help'.
